...
export default function SplashPage() {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4 transition-opacity duration-300 opacity-100">
      {/* Main content */}
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 py-12 sm:py-16 px-6 sm:px-8 space-y-8">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-300 dark:via-blue-500 to-transparent" />
              <div className="w-1.5 h-1.5 bg-blue-400 dark:bg-blue-300 rounded-full" />
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-purple-300 dark:via-purple-500 to-transparent" />
            </div>

            {/* Scripture quote - Montserrat font */}
            <blockquote className="space-y-4">
              <p className="text-xl sm:text-2xl text-gray-800 dark:text-gray-100 leading-relaxed font-sans font-light">
                "{t.scripture}"
              </p>
              <footer className="text-base sm:text-lg text-gray-700 dark:text-gray-300 font-sans font-medium">
                {t.bibleReference}
              </footer>
            </blockquote>
            ...
            <div className="pt-4 border-t border-white/20 dark:border-white/10">
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 font-sans italic">Serve with love.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-2">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 font-sans">{t.redirecting}</p>
          <div
            className="w-2 h-2 bg-purple-400 dark:bg-purple-300 rounded-full animate-pulse"
            style={{ animationDelay: "300ms" }}
          />
        </div>
      </div>
