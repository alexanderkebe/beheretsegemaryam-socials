        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 py-12 sm:py-16 px-6 sm:px-8 space-y-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <img
                  ...
                  className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 object-cover rounded-full ring-4 ring-white/20 shadow-2xl"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm sm:text-base font-semibold text-gray-400 dark:text-gray-400">{t.feedTheHungry}</p>
            </div>
